   ...
   //{      
      ...
      if(dwm_loc_get(&loc) == RV_OK)
      {
         ...
         for (i = 0; i < loc.anchors.dist.cnt; ++i) 
         {
            ...
            {
                _position->x=loc.anchors.an_pos.pos[i].x;
                _position->y=loc.anchors.an_pos.pos[i].y;
                _position->z=loc.anchors.an_pos.pos[i].z;
                _position->qf=loc.anchors.an_pos.pos[i].qf;
